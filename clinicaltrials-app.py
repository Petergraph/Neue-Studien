...
def fetch_new_studies(days: int):
    ...
    über die Version 2 API.
    Da der V2-Endpunkt keine RANGE-Query für Datum unterstützt, wird jede Einzeldatumä    Da der V2-Endpunkt keine RANGE-Query für Datum unterstützt, wird jede Einzeldatumäbrs
    abgefragt und die Resultate zusammengefü    abgefragt und die Resultate zusammengeführt.
    """
    studies = []
